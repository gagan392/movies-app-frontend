		...
		return (
			<Router>
				<div className="main-container">
					...
					<Route path='/bookshow/:id' render={(props) => <BookMovieShow {...props} apiClient={apiClient} />} />
					<Route path='/confirm/:id' render={(props) => <ConfirmMovieShow {...props} apiClient={apiClient} />} />
				</div>
			</Router>
		)
	}
